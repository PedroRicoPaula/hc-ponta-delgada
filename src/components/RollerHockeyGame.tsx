...
const allPlayersData = {
  "Seniores": {
    ...
    "Jogadores": ["Tiago Pimentel", "Marco Resendes", "David Reis", "Alexandre Resendes", "Alexandre Ornelas", "Pedro Paula", "Francisco Freitas", "Tiago Leite", "Miguel Pimentel", "Carlos Guimarães", "Vicente Correia"]
  },
  "Formação": {
    "Guarda-Redes": {
