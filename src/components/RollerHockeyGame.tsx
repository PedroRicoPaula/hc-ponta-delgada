      ...
      <div className="relative h-full bg-gradient-to-br from-primary/5 via-background to-primary/10">
        ...
        <div className="p-6 pb-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-2xl font-bold text-foreground">Mini Jogo</h2>
          </div>
          <p className="text-muted-foreground text-sm">Seleciona os teus "Starting 5" e vê quem ganha!</p>
        </div>

        <div className="px-6 pb-6 space-y-6">
          {/* Teams Selection - Side by Side on larger screens, stacked on mobile */}
            ...
            {gameResult ? (
              <div className="text-center space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className={`p-3 rounded-lg ${gameResult.winner === 'Team 1' ? 'bg-blue-100 border-2 border-blue-500' : 'bg-muted'}`}>
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                      <span className="font-medium text-sm">Equipa 1</span>
                    </div>
                    <div className="text-2xl font-bold text-center">{gameResult.team1Percentage}%</div>
                  </div>
                  
                  <div className={`p-3 rounded-lg ${gameResult.winner === 'Team 2' ? 'bg-red-100 border-2 border-red-500' : 'bg-muted'}`}>
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                      <span className="font-medium text-sm">Equipa 2</span>
                    </div>
                    <div className="text-2xl font-bold text-center">{gameResult.team2Percentage}%</div>
                  </div>
                </div>
