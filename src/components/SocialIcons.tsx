...
export const SocialIcons = () => {
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className={`fixed left-0 top-1/2 -translate-y-1/2 z-40 bg-white/90 backdrop-blur-sm rounded-r-lg shadow-lg flex flex-col gap-4 p-3 transform transition-transform duration-300 ease-in-out sm:hidden
