...
export const merchProducts: MerchProduct[] = [
  {
    ...
    sizes: 'apparel',
    variants: ['Principal (branca)', 'Alternativa'],
    note: 'Principal é a branca. A outra face é a alternativa.',
    priceMember: 23,
    priceNonMember: 27,
  },
  {
    ...
    sizes: 'apparel',
    variants: ['Principal (roxa)', 'Alternativa'],
    note: 'Principal é a roxa. A outra face é a alternativa.',
    priceMember: 23,
    priceNonMember: 27,
  },
  {
    ...
    note: 'Camisolas reversíveis e calções pretos. Jogador: principal branca. Guarda-redes: principal roxa.',
    priceMember: 45,
    priceNonMember: 49,
  },
  {
