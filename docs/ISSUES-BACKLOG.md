...
### SEO — og:image e structured data
- Adicionar `og:image` específico por página (evitar imagem genérica)
- Implementar Schema.org `SportsOrganization` e `SportsEvent` para SEO estruturado
